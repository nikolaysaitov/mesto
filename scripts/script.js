...
let nameInput = document.querySelector('.name__input');  // Воспользуйтесь инструментом .querySelector()
let jobInput = document.querySelector('.job__input');  // Воспользуйтесь инструментом .querySelector()
